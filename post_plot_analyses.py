...
from train_and_evaluate import load_train_test_data, train_mlr, get_mlr_coefficients

# Load data again (to get df_train)
df_train, _, X_train, _, y_train, _, predictors, predictands = load_train_test_data()
